...
def create_display_labels():
    total_label = tk.Label(display_frame, text= total_expression, anchor= tk.E, bg= light_gray, fg= label_color, padx= 20, font= fonts_list[1])
    total_label.pack(expand= True, fill= "both")
    
    label = tk.Label(display_frame, text= current_expression, anchor= tk.E, bg= light_gray, fg= label_color, padx= 20, font= fonts_list[0])
...
def create_digit_buttons():
    for digit, grid_value in digits.items():
        button = tk.Button(button_frame, text= str(digit), bg= white, fg= label_color, font= fonts_list[2], borderwidth= 0, command=lambda x=digit: add_to_expression(x))
...
def create_operator_buttons():
    r = 1
    for operator, symbol in operators.items():
        button = tk.Button(button_frame, text= symbol, bg= offwhite, fg= label_color, font= fonts_list[3], borderwidth= 0, command= lambda x=operator: add_operators(x))
        button.grid(row= r, column= 4, sticky= tk.NSEW)
        r += 1
create_operator_buttons()

def create_fac_button():
    button = tk.Button(button_frame, text= "!", bg= white, fg= label_color, font= fonts_list[3], borderwidth= 0, command= lambda: fac_func())
    button.grid(row= 5, column= 3, sticky= tk.NSEW)

def create_clear_button():
    button = tk.Button(button_frame, text= "C", bg= offwhite, fg= label_color, font= fonts_list[3], borderwidth= 0, command= lambda: clear())
    button.grid(row= 0, column= 1, sticky= tk.NSEW)

def create_sin_button():
    button = tk.Button(button_frame, text= "sin", bg= offwhite, fg= label_color, font= fonts_list[3], border= 0, command= lambda: sin_func())
    button.grid(row= 0, column= 2, sticky= tk.NSEW)

def create_cos_button():
    button = tk.Button(button_frame, text= "cos", bg= offwhite, fg= label_color, font= fonts_list[3], border= 0, command= lambda: cos_func())
    button.grid(row= 0, column= 3, sticky= tk.NSEW)

def create_tan_button():
    button = tk.Button(button_frame, text= "tan", bg= offwhite, fg= label_color, font= fonts_list[3], border= 0, command= lambda: tan_func())
    button.grid(row= 0, column= 4, sticky= tk.NSEW)

def create_square_button():
    button = tk.Button(button_frame, text= "x\u00b2", bg= offwhite, fg= label_color, font= fonts_list[3], borderwidth= 0, command= lambda: square())
    button.grid(row= 1, column= 2, sticky= tk.NSEW)

def create_sqrt_button():
    button = tk.Button(button_frame, text= "\u221ax", bg= offwhite, fg= label_color, font= fonts_list[3], borderwidth= 0, command= lambda: sqrt())
    button.grid(row= 1, column= 3, sticky= tk.NSEW)

def create_power_button():
    button = tk.Button(button_frame, text= "^", bg= offwhite, fg= label_color, font= fonts_list[3], borderwidth= 0, command= lambda: add_power_operator())
    button.grid(row= 1, column= 1, sticky= tk.NSEW)

def create_equals_to_button():
    button = tk.Button(button_frame, text= "=", bg= light_blue, fg= label_color, font= fonts_list[3], borderwidth= 0, command=lambda: evaluate())
